...
class PopChromosome(object):
    ...
    def make_contact_matrix(self):
        ...
        positions = np.arange(self.lower_bp_lim, self.upper_bp_lim, self.bin_size, dtype=np.int32)
...
class PopTrans(object):
    ...
    def make_contact_matrix(self):
        ...
        positions_a = np.arange(self.lower_bp_lim_a, self.upper_bp_lim_a, self.bin_size, dtype=np.int32)

        positions_b = np.arange(self.lower_bp_lim_b, self.upper_bp_lim_b, self.bin_size, dtype=np.int32)
